...
const Bangles = ({ addToWishlist }) => {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await axiosInstance.get("/getProductByCategory/Bangles");
    ...
    <div>
     <div className="Banner">
      ...
      {/* <div className="Banner">
         <img
          style={{ height:  "auto" }}
          src="https://img.freepik.com/premium-photo/designer-royal-pendant-jewel-banner-design-generative-ai_753390-6229.jpg"
          className="d-block w-100"
          alt="Bangles"
        />
      </div> */}
