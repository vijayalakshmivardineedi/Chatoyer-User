...
const Rings = ({ addToWishlist }) => {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await axiosInstance.get("/getProductByCategory/Rings");
    ...
    <div>
      ...
      <div>
        <img
          style={{ height: 400 }}
          className="d-block w-100"
          src="https://www.mallardjewellers.co.uk/images/banners/homepage_banner_desktop10062022073711.jpg"
           alt="Ringbanner"
        />
      </div>
      {showPopup && (
