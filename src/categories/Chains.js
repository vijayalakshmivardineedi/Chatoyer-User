...
const Chains = ({ addToWishlist }) => {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await axiosInstance.get("/getProductByCategory/Chains");
    ...
    <div>
     <div className="Banner">
      ...
      <div className="Banner">
         <img
          style={{ height: 405 }}
          src="https://th.bing.com/th/id/R.6514220c7cadcb3bbd3c5a20dc6e52d3?rik=EMsXZ%2blhagvzkg&riu=http%3a%2f%2fwww.mannatjewels.com%2fimages%2finner_page%2fnecklace%2f5.jpg&ehk=tq88KFUkNWEMzNzbN5l01SVwxmNPipOpDJcTMU2YLoM%3d&risl=&pid=ImgRaw&r=0"
           className="d-block w-100"
          alt="Chains"
        />
      </div>
