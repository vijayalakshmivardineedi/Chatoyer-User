...
function AboutPage() {
  ...
  return (
    <div className="about-page">
      <div className="faces">
        <h1 style={{ color: "#4f3267", fontFamily: "'Domine', serif", }}><b>ABOUT US</b></h1>
      </div>
      <div className="about-content">
        ...
        <div className="about-right">
          <p>
            <span style={{ color: '#de57e5' }}>Chatoyer</span> Group was founded in 1993 by a team of enterprising entrepreneurs,
            ...
            city called <span style={{ color: '#de57e5' }}>Chatoyer</span>. Since then, keeping alive the golden spirit of the brand, the Group
            has remained constant, in its successful forays nurtured by expertise, vision and guidance,
            into a formidable business conglomerate. The HQ (headquarters) of <span style={{ color: '#de57e5' }}>Chatoyer</span> Group located in
            Hyderabad shines bright as a beacon of success for an empire built on Trust, Teamwork, and
            Goodwill.
          </p>

        </div>
      </div>
      <h1 className="faces">FACES OF  <span style={{ color: '#de57e5' }}>CHATOYER</span> JEWELERY</h1>
      ...
      <div>
        <p className="faces"><span style={{ color: '#de57e5' }}>CHATOYER</span> JEWELERY</p>
