  ...
  return (
    <div className="disclaimer_header">
      <div className="disclaimer">
        <h1 style={{ color: "#4f3267", fontFamily: "'Domine', serif" }}>
      ...
      <div className="disclaimer-content">
        <p className="paracontent">
          ...
          The information is provided by <span style={{ color: '#de57e5' }}>Chatoyer</span> and while we endeavour to keep the information
        ...
        <p className="paracontent">
          ...
          of <span style={{ color: '#de57e5' }}>Chatoyer</span>. We have no control over the nature, content, and availability of those
          sites. The inclusion of any links does not necessarily imply a recommendation or endorse the
          views expressed within them.
        </p>
        <p className="paracontent">
          Every effort is made to keep the website up and running smoothly. However, <span style={{ color: '#de57e5' }}>Chatoyer</span> takes no
          responsibility for, and will not be liable for, the website being temporarily unavailable due
          to technical issues beyond our control.
        </p>
        <p className="paracontent">
          If there are any questions regarding this website disclaimer policy, you may contact us using the
          information below:
        </p>
      </div>
      <div className="paracontent">
        <p className="paracontent">
          <b style={{ fontFamily: "'Domine', serif" }}>ADDRESS:</b> Banjara Hills, Hyd 8-2-626/2 Road No. 10, Banjara Hills,
          Hyderabad-500034, Telangana, India
        </p>
        <p className="paracontent">
          <b style={{ fontFamily: "'Domine', serif" }}>CONTACT NUMBER:</b> +91 98456 23985
        </p>
        <p className="paracontent">
